...
- Run live YOLO smoke tests in a temporary workspace against the local vLLM server.
- Run behavioral tool tests for web search and PDF/DOCX/XLSX generation, documenting missing capabilities honestly.
